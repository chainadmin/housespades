...
After investigating what could have appeared misleading, we identified that our computer opponents ("bots") were shown with human-like names and no visible indication that they were computer-controlled. We agree this could look like undisclosed behavior, and we have fixed it in this build (v2.1.1, build 40):
...
- Bump handled: this build is v2.1.1 / iOS build 40 / Android versionCode 39.
